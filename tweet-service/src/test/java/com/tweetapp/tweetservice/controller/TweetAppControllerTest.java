...
//check page size
	...
	void testGetAllTweetsPaged() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/all?isPaged=true&page=0&size=5")).andDo(print()).andExpect(status().isOk())
	...
	void testGetAllTweetsPagedException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/all?isPaged=true&page=0&size=5")).andDo(print())
	...
	void testGetUserTweetsPaged() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/sam?isPaged=true&page=0&size=5")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetUserTweets() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/sam")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetUserTweetsException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/sam?isPaged=true&page=0&size=5")).andDo(print())
				.andExpect(status().isInternalServerError());
	}
	...
	void testSearchTweetsPaged() throws Exception {
		...
		when(tweetService.searchTweetsPaged(any(), anyInt(), anyInt())).thenReturn(getTweetEntityPage());
		this.mockMvc.perform(get(PATH + "/search?isPaged=true&page=0&size=5")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testSearchTweets() throws Exception {
		...
		when(tweetService.searchTweets(any())).thenReturn(getTweetEntityList());
		this.mockMvc.perform(get(PATH + "/search")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testSearchTweetsException() throws Exception {
		...
		when(tweetService.searchTweetsPaged(any(), anyInt(), anyInt())).thenThrow(new TweetServiceException("TEST"));
		this.mockMvc.perform(get(PATH + "/search?isPaged=true&page=0&size=5")).andDo(print())
				.andExpect(status().isInternalServerError());
	}

	@Test
	void testSearchTweetsDateException() throws Exception {
		this.mockMvc.perform(get(PATH + "/search?startDateTime=TEST")).andDo(print())
	...
	void testGetTrendingTopics() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/trend")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}

	@Test
	void testGetTrendingTopicsDateException() throws Exception {
		this.mockMvc.perform(get(PATH + "/trend?startDateTime=TEST")).andDo(print()).andExpect(status().isBadRequest());
	}
	...
	void testGetTrendingTopicsException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/trend")).andDo(print()).andExpect(status().isInternalServerError());
	}

	@Test
	void testGetHashtags() throws Exception {
		when(tweetService.getHashtags()).thenReturn(getHashtags());
		this.mockMvc.perform(get(PATH + "/all/hashtags")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetHashtagsException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/all/hashtags")).andDo(print()).andExpect(status().isInternalServerError());
	}
	...
	void testPostNewTweetBadRequest() throws Exception {
		...
		this.mockMvc.perform(post(PATH + "/TEST/add").content(objectMapper.writeValueAsString(tweetDto))
	...
	void testUpdateTweetSuccess() throws Exception {
		...
		this.mockMvc
				.perform(put(PATH + "/TEST/update/" + TWEET_ID).content(objectMapper.writeValueAsString(getTweetDto()))
						.contentType(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isCreated())
	...
	void testUpdateTweetBadRequest() throws Exception {
		TweetDto tweetDto = getTweetDto();
		tweetDto.setTweetMessage(null);
		this.mockMvc.perform(put(PATH + "/TEST/update/" + TWEET_ID).content(objectMapper.writeValueAsString(tweetDto))
				.contentType(MediaType.APPLICATION_JSON)).andDo(print()).andExpect(status().isBadRequest());
	}
	...
	void testLikeTweetSuccess() throws Exception {
		...
		this.mockMvc
				.perform(patch(PATH + "/TEST/like/" + TWEET_ID).content(objectMapper.writeValueAsString(getTweetDto()))
						.contentType(MediaType.APPLICATION_JSON))
	...
	void testReplyTweetSuccess() throws Exception {
		...
		this.mockMvc
				.perform(post(PATH + "/TEST/reply/" + TWEET_ID).content(objectMapper.writeValueAsString(getTweetDto()))
						.contentType(MediaType.APPLICATION_JSON))
				.andDo(print()).andExpect(status().isCreated())
	...
	void testDeleteTweetSuccess() throws Exception {
		...
		this.mockMvc
				.perform(delete(PATH + "/TEST/delete/" + TWEET_ID)
	...
	void testDeleteTweetException() throws Exception {
		...
		this.mockMvc.perform(delete(PATH + "/TEST/delete/" + TWEET_ID)
	...
	void testGetAllUsersPaged() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/all?isPaged=true&page=0&size=5")).andDo(print())
	...
	void testGetAllUsers() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/all")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetAllUsersException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/all")).andDo(print()).andExpect(status().isInternalServerError());
	}

	@Test
	void testGetUserPaged() throws Exception {
		when(userService.searchUsersPaged(any(), anyInt(), anyInt())).thenReturn(getPagedUserEntity());
		this.mockMvc.perform(get(PATH + "/users/search/test?isPaged=true&page=0&size=5")).andDo(print())
				.andExpect(status().isOk()).andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetUser() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/search/test")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetUserException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/search/test")).andDo(print())
				.andExpect(status().isInternalServerError());
	}
	...
	void testSearchUsersPaged() throws Exception {
		when(userService.searchUsersPaged(any(), anyInt(), anyInt())).thenReturn(getPagedUserEntity());
		this.mockMvc.perform(get(PATH + "/users/search?isPaged=true&page=0&size=5")).andDo(print())
				.andExpect(status().isOk()).andExpect(content().string(containsString(TEST)));
	}
	...
	void testSearchUsers() throws Exception {
		...
		when(userService.searchUsers(any())).thenReturn(getUserEntityList());
		this.mockMvc.perform(get(PATH + "/users/search")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testSearchUsersException() throws Exception {
		...
		when(userService.searchUsers(any())).thenThrow(new TweetServiceException(TEST));
		this.mockMvc.perform(get(PATH + "/users/search")).andDo(print()).andExpect(status().isInternalServerError());
	}
	...
	void testGetUsertags() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/usertags")).andDo(print()).andExpect(status().isOk())
				.andExpect(content().string(containsString(TEST)));
	}
	...
	void testGetUsertagsException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/users/usertags")).andDo(print()).andExpect(status().isInternalServerError());
	}
	...
	void testExportCSV() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/test/export")).andDo(print()).andExpect(status().isOk());
	}
	...
	void testExportCSVException() throws Exception {
		...
		this.mockMvc.perform(get(PATH + "/test/export")).andDo(print()).andExpect(status().isInternalServerError());
	}
